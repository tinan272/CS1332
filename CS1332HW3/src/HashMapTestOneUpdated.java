...
public class HashMapTestOneUpdated {
    ...
    @Test
    public void resizeWithChainTestOne() {
        assertNull(map.put(0, "A"));
        assertNull(map.put(1, "B"));
        assertNull(map.put(2, "C"));
        assertNull(map.put(3, "D"));
    ...
    @Test
    public void resizeWithChainTestTwo() {
        assertNull(map.put(0, "Z"));
        assertNull(map.put(2, "X"));
        assertNull(map.put(6, "K"));
        assertNull(map.put(8, "Y"));

        /*
            Z _ X _ _ _ K _ Y
         */

        assertNull(map.put(5, "L"));

        //Chain
        assertNull(map.put(13, "M"));
        assertNull(map.put(18, "O"));
        assertNull(map.put(21, "R"));

        /*
            Z         L     Y
            |         |     |
            M _ X _ _ O K _ R _ _ _ _ _
         */
        ...
        /* RESIZE
            Z
            |
            J K X _ _ L K _ Y _ _ _ _ M _ _ _ _ O _ _ R _ _ _ _ I
         */
        ...
        expected[0] = new MapEntry<>(27, "J");
        expected[1] = new MapEntry<>(28, "K");
        expected[2] = new MapEntry<>(2, "X");
        expected[5] = new MapEntry<>(5, "L");
        expected[6] = new MapEntry<>(6, "K");
        expected[8] = new MapEntry<>(8, "Y");
        expected[13] = new MapEntry<>(13, "M");
        expected[18] = new MapEntry<>(18, "O");
        expected[21] = new MapEntry<>(21, "R");
        expected[26] = new MapEntry<>(26, "I");

        MapEntry<Integer, String> curr = map.getTable()[0];
        assertEquals("J", curr.getValue());
        curr = curr.getNext();
        assertEquals("Z", curr.getValue());
    ...
    public void putDuplicates() {
        ...
        /*
            Z         L
            |         |
            M _ X _ _ O K _ _ _ _ _ _ _
         */

        //duplicates
        assertEquals("X", map.put(2, "T"));
        assertEquals("L", map.put(5, "S"));

        /* The duplicate should replace X and L with T and S and X and L should be returned.
            Z         S
            |         |
            M _ T _ _ O K _ _ _ _ _ _ _
         */
        ...
        expected[0] = new MapEntry<>(13, "M");
        expected[2] = new MapEntry<>(2, "T");

        expected[5] = new MapEntry<>(18, "O");
        expected[6] = new MapEntry<>(6, "K");

        MapEntry<Integer, String> curr = map.getTable()[0];
        assertEquals("M", curr.getValue());
        curr = curr.getNext();
        assertEquals("Z", curr.getValue());

        curr = map.getTable()[5];
        assertEquals("O", curr.getValue());
        curr = curr.getNext();
        assertEquals("S", curr.getValue());
    ...
    @Test
    public void duplicatesInChain() {
        assertNull(map.put(0, "Z"));
        assertNull(map.put(13, "X"));
        assertNull(map.put(18, "K"));
        assertNull(map.put(5, "L"));
        assertNull(map.put(8, "F"));

        /*
            Z         K
            |         |
            X _ _ _ _ L _ _ F _ _ _ _ _
         */

        //Chain
        assertNull(map.put(26, "M"));
        assertNull(map.put(31, "O"));
        ...
        /*
            ...
            X         L
            |         |
            M _ _ _ _ O _ _ F _ _ _ _ _
         */

        //duplicates
        assertEquals("Z", map.put(0, "Q"));
        assertEquals("L", map.put(5, "C")); //5
        assertEquals("F", map.put(8, "G")); //8

        /* The duplicate should replace Z and L with Q and C and Z, L, and F should be returned.
            Q         K
            |         |
            X         C
            |         |
            M _ _ _ _ O _ _ G _ _ _ _ _
         */
        ...
        expected[0] = new MapEntry<>(26, "M");
        expected[5] = new MapEntry<>(31, "O");

        expected[8] = new MapEntry<>(8, "G");

        MapEntry<Integer, String> curr = map.getTable()[0];
        assertEquals("M", curr.getValue());
        curr = curr.getNext();
        assertEquals("X", curr.getValue());
        curr = curr.getNext();
        assertEquals("Q", curr.getValue());
    ...
    @Test
    public void duplicatesReplaceAll() {
        assertNull(map.put(0, "Z"));
        assertNull(map.put(13, "X"));
        assertNull(map.put(26, "K"));
        assertNull(map.put(39, "L"));
        assertNull(map.put(52, "F"));
        assertNull(map.put(2, "M"));
        ...
        /*  Z
            ...
            L   M
            |   |
            F _ O _ _ _ _ _ _ _ _ _ _ _
         */


        //duplicates
        assertEquals("Z", map.put(0, "A"));
        assertEquals("X", map.put(13, "B"));
        assertEquals("K", map.put(26, "C"));
        assertEquals("L", map.put(39, "D"));
        assertEquals("F", map.put(52, "E"));
        assertEquals("M", map.put(2, "H"));
        assertEquals("O", map.put(15, "I"));

        /* The new hashtable should be
            A
            |
            B
            |
        ...
        expected[0] = new MapEntry<>(52, "E");
        expected[2] = new MapEntry<>(15, "I");
        ...
        curr = map.getTable()[2];
        assertEquals("I", curr.getValue());
        curr = curr.getNext();
        assertEquals("H", curr.getValue());
