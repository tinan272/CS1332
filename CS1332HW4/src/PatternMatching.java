...
public class PatternMatching {
    ...
    public static List<Integer> kmp(CharSequence pattern, CharSequence text,
        ...
        if (pattern == null || pattern.length() == 0) {
            throw new IllegalArgumentException("pattern is length 0 or null.");
        }
        if (comparator == null || text == null) {
            throw new IllegalArgumentException("Comparator or text or both are null.");
        }
    ...
    public static List<Integer> boyerMoore(CharSequence pattern,
                                           ...
                                           CharacterComparator comparator) {
        if (pattern == null || pattern.length() == 0) {
            throw new IllegalArgumentException("Pattern cannot be null or length 0");
        }
        ...
        while (i <= text.length() - pattern.length()) {
            ...
            if (j == -1) {
                ...
                int shiftT = lastTable.getOrDefault(text.charAt(i + j), -1);
                if (shiftT < j) {
                    i = i + j - shiftT;
                } else {
                    i++;
    ...
    public static List<Integer> rabinKarp(CharSequence pattern,
        ...
        for (int i = pattern.length() - 1; i >= 0; i--) {
            patternHash += pattern.charAt(i) * expNum;
            textHash += text.charAt(i) * expNum;
            if (i == 0) {
                break;
            }
            expNum *= BASE;
        ...
        while (i < text.length() - pattern.length() + 1) {
            ...
            if (i != text.length() - pattern.length()) {
                textHash = ((textHash - text.charAt(i) * expNum) * BASE + text.charAt(i + pattern.length()));
            }
            i++;
        }
        return rList;
